...
},{"./script.ts":"gg0zR"}],"gg0zR":[function(require,module,exports) {
document.addEventListener("DOMContentLoaded", function() {
    const lightGalleryElement = document.getElementById("lightgallery");
    if (lightGalleryElement) lightGallery(lightGalleryElement);
    else console.error('Element with id "lightgallery" not found.');
});

},{}]},["Q9dUj","bNKaB"], "bNKaB", "parcelRequire716c")
